...
import com.chan.utilities.MonitoringMail;
import com.chan.utilities.TestConfig;
	...
	public void onFinish(ISuite arg0) {
		...
		try {
			messageBody = "http://" + InetAddress.getLocalHost().getHostAddress()
					+ ":8080/job/ChanPOMBasics/ChanPOMBasic_Extent_Report/";
